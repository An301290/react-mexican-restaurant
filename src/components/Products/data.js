import imgPastor from "../../Images/tacos-al-pastor.jpg";
...
export const productDataTaco = [
  {
    ...
    alt: "Taco",
    name: "Taco al Pastor",
    desc: "Marinara sauce, basil, italian sausage, pork meat",
    price: "$9.99",
    button: "Add to Cart",
  },
  {
  ...
  },
  {
    ...
    desc: " Marinara sauce, basil, garlic, shrimps",
    price: "$12.99",
    button: "Add to Cart",
  },
];

export const productDataMargaritas = [
  {
    img: imgMlimon,
    alt: "Margarita",
